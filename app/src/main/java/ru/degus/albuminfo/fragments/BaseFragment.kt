...
import ru.degus.albuminfo.activities.MainActivity
import ru.degus.albuminfo.activities.MainNavigator
...
abstract class BaseFragment<B : ViewDataBinding>(private val layoutId: Int) : Fragment() {
    ...
    fun showInformDialog(title: String, message: String?, call: (() -> Unit)? = null) {
